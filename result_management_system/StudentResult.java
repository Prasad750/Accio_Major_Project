    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                int s5=Integer.parseInt(jTextField19.getText());
                
                int totalMarks= s1+s2+s3+s4+s5;
                DecimalFormat df=new DecimalFormat("#.##");
                double per=1.00*totalMarks/5;
                
                jTextField22.setText(String.valueOf(totalMarks));
                jTextField8.setText(String.valueOf(df.format(per))+"%");
